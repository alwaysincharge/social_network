            ...
            <div class="row main-body-div">
                ...
                <div class="col-xs-11">
                    ...
                    <div class="col-xs-2">
                        ...
                        <textarea id="name" type="text" class="search-main" placeholder="write something" style="margin-bottom: 10px; width: 100%; height: 100px; resize: none; outline: none;"></textarea><br>
                     
                    
                        <a><img src="attachment.svg" style="width: 20px;"  /></a>
